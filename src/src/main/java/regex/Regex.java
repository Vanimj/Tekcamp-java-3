...
public class Regex {
	...
	public static void main(String[] args) {
		...
		// 4.a Create an array of all the words besides the word 'sleepy'. Each word
		// does not have to be a separate element,
		// although you can split it that way if you wish. We just want an array that
		// everything that is not 'sleepy'.
		...
		System.out.println("The result string with no sleepy: " + not_sleepy);
		...
		System.out.println("Removing punctuations : " + notSleepy);

		// 4.d Now replace all the occurences of 'sleepy' with the word 'happy'. Call
		// the new string happy.
		...
		// https://jrgraphix.net/r/Unicode/2190-21FF is a selection of
		// unicode arrow symbols to aid you in your search. Match all the codes that are
		// arrows, and then print them out to the
